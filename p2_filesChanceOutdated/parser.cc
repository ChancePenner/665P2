...
#line 654 "parser.cc"
  ...
  case 8:
#line 171 "negatron.yy"
    {
  bool isRef = (yystack_[0].value.transBool);
  (yylhs.value.transType) = new BoolTypeNode((yystack_[1].value.transToken)->line(), (yystack_[1].value.transToken)->col(), isRef);
  }
#line 663 "parser.cc"
    break;

  case 9:
#line 176 "negatron.yy"
    {
    // bool isRef = false;
...
#line 684 "parser.cc"
  ...
  case 11:
#line 253 "negatron.yy"
    { (yylhs.value.transBool) = true; }
#line 690 "parser.cc"
    break;

  case 12:
#line 255 "negatron.yy"
    { (yylhs.value.transBool) = false; }
#line 696 "parser.cc"
    break;

  case 13:
#line 258 "negatron.yy"
...
#undef YYCASE_
  ...
  Parser::yypact_[] =
  {
     -16,     4,    -3,   -16,     3,     3,   -16,    -9,   -16,   -16,
      -9,   -16,   -16,   -16,   -16,     3,   -15,   -16,   -16
  };

  const unsigned char
  Parser::yydefact_[] =
  {
       4,     0,     2,     1,    12,    12,     9,     0,     3,     5,
       0,    11,     8,     7,    13,    12,     0,    10,     6
  };

  const signed char
  Parser::yypgoto_[] =
  {
     -16,   -16,   -16,   -16,   -16,   -16,    -5,    -1
  };
  ...
  Parser::yystos_[] =
  {
       0,    38,    39,     0,     4,     5,     6,     8,    40,    41,
      42,     3,    43,    43,    16,    44,    44,    43,    23
  };

  const unsigned char
  Parser::yyr1_[] =
  {
       0,    37,    38,    39,    39,    40,    41,    42,    42,    42,
      42,    43,    43,    44
  };
  ...
  {
  "\"end of file\"", "error", "$undefined", "REF", "BOOL", "INT", "VOID",
  "FALSE", "STRUCT", "NULLREF", "OUTPUT", "INPUT", "IF", "ELSE", "WHILE",
  "RETURN", "ID", "INTLITERAL", "STRLITERAL", "LCURLY", "RCURLY", "LPAREN",
  "RPAREN", "SEMICOLON", "COMMA", "DOT", "DASHDASH", "DASH", "STAR",
  "SLASH", "NOT", "NOTEQUALS", "LESS", "LESSEQ", "ASSIGN", "AND", "OR",
  "$accept", "program", "globals", "decl", "varDecl", "type", "maybeRef",
  "id", YY_NULLPTR
  };
  ...
  Parser::yyrline_[] =
  {
       0,   131,   131,   138,   145,   152,   158,   165,   170,   175,
     180,   252,   255,   258
  };
